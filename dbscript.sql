...
BEGIN TRANSACTION;
insert into project ("projectID", "creator", "title", "description", "dateCreated", "dateUpdated", "status", "postsURL") values ('1', 'Tutnix', 'SinnvollesProjekt', 'Ein sehr Sinnvolles Projekt', '1268395381000', '1434295200000', 'published','http://www.heise.de/newsticker/heise-atom.xml');
insert into project ("projectID", "creator", "title", "description", "dateCreated", "dateUpdated", "status", "postsURL") values ('2', 'Quadratus', 'WebApp', 'Erstellung einer WebApp für die HSMW', '1321018620000', '', 'published','http://rss.golem.de/rss.php?feed=ATOM1.0');
...
insert into project ("projectID", "creator", "title", "description", "dateCreated", "dateUpdated", "status") values ('7', 'Tutnix', 'BliBlaBLubber', 'Lorem Ipsum', '1440689700000', NULL, 'new');
